package com.iexpress.android.twittersearch;
...
public class TwitterSearchActivity extends AppCompatActivity {
    ...
    private void updateSaveFAB() {
        ...
        if (queryEditText.getText() == null || queryEditText.getText().toString().isEmpty() ||
            ...
            new View.OnLongClickListener() {
                ...
                public boolean onLongClick(View view) {
                    ...
                    AlertDialog.Builder builder =
                            new AlertDialog.Builder(TwitterSearchActivity.this);
    ...
    // following from the menu (auto generated code, may not be used in this project)
